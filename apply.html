...
<!--										<li><a href="#">Magna veroeros</a></li>
			...
			but remember, you've joined a difficult contest 😜<br> </span>
					</p>
						</div>
						<div class="" style="margin-left:25%;margin-right:65%;">
							<div class="col-12-medium">

								<!-- Contact Form -->
									<section>
										<form id="applyform" method="post" action="application.php">
										 <h2 style="color:#e97770; text-align:left; width:300px; margin-bottom:5%; font-size:125%;">Ingame Name</h2>
											<div class="row gtr-50">
												<div class="col-12">
													<input class="formwidth" type="text" name="name" id="name" placeholder="Notch" required/>
												</div>
												<div class="col-12">
												<h2 style="color:#e97770; text-align:left; width:300px; margin-bottom:5%; font-size:125%;">Email</h2>
													<input class="formwidth" type="text" name="email" id="email" placeholder="Yourmail@gmail.com" required/>
												</div>
												<div class="col-12">
												<h2 style="color:#e97770; text-align:left; width:300px; margin-bottom:5%; font-size:125%;">Message</h2>
													<textarea class="formwidth" name="message" id="message" placeholder="Message..." rows="4" required></textarea>
												</div>
												<div class="col-12">
													<ul class="actions">
